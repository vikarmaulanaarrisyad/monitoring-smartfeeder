...
@push('scripts')
    <script>
        ...
        table = $('.penjadwalanpakan').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: false,
            responsive: true,
        ...
        function addData(url, title = 'Form Tambah Penjadwalan Pakan') {
            $(modal).modal('show');
        ...
        function editData(url, title = "Edit") {
            $.get(url)
                .done(response => {
                    $(modal).modal('show');
                    $(`${modal} .modal-title`).text(title);
                    ...
                    //var option = new Option(response.data.providers, response.data.provider_id, true, true);
